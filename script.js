// let password = prompt('password123')
// if (password === 123) {
// }else {    
// }

// let smth = prompt('parol')
// console.log(smth);
// alert()
...
//     alert("away");
// }
// let list = "putin alibek Shavkat biden"
// let name = prompt('what is your name?').toLowerCase.trin
...
// if (1 > age && age <10) {
//     alert("u are a baby")
// } else if (11 > age && age < 22) {
//     alert("u are welcome")
// } else if(23 > age && age < 33) {
//     alert("big human")
...
// if (name === 'Alex') {
//     console.log("welcome")
//     let chet = prompt('credit card')

//     if (chet == 7777) {
//         console.log("nice");
//         let sale = prompt('сколько обналичить?')
//         if (sale <= many) {
//             console.log("everything good");
//         } else{
//             console.log('you dont have many');
//         }
...
// let club = prompt('what is your name?').toLowerCase().trim()
// if (club[0] === 'a') {
//     let age = prompt('How old are you?').trim()
//     if (age > 19 && age < 41) {
//         console.log('welcome');
//         let money = prompt('how much many you have?')
//         if (money > 99) {
//             alert('you are welcome')
//         } else {
//             alert('go home never come back')
//         }
//     } else {
//         alert('go home')
//     }
...
// users.filter(item => {
//     let finded = item.email.split('.').at(-1)
//     if (finded === 'org'){
...
// // let find = users.filter(item => users ) ({
//     if (item = emails[0]) {
...
//     }
// }) 
// let idx = users.indexOf('.net')
// let finded = users.find((user) => user[-1] === '.com')
// let finded = users.reduce((a,b) => {
//     if (users[-1] === '.net') {
//         // a.users += b.users
//         emails.net.push(a,b)
//     }
// })
// console.log(finded,emails);
// console.log(users);

// users.reduce(user => {
//     let finded = user.email.split('@')[1].split('.')[-1];
//     emails.finded || emails.other.push(users);
// });
...
// users.filter((item) => {
//     let find = item.email.split('.').at(-1)

//     if (emails[find]) {
//         emails[find].push(item)
//     } else {
//         other.push(item.email)
//     }
// }
